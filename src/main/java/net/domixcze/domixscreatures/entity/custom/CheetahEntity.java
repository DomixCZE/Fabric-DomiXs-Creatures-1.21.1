...
public class CheetahEntity extends AnimalEntity implements GeoEntity, Sleepy, SnowLayerable {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        AnimationController<CheetahEntity> landController = new AnimationController<>(this, "land_controller", 3, this::landPredicate);
        landController.triggerableAnim("attack", RawAnimation.begin().then("animation.cheetah.attack", Animation.LoopType.PLAY_ONCE));
