...
public class CapybaraSnowyLayer extends GeoRenderLayer<CapybaraEntity>  {
    public CapybaraSnowyLayer(GeoRenderer<CapybaraEntity> entityGeoRenderer) {
    ...
    public void render(MatrixStack poseStack, CapybaraEntity animatable, BakedGeoModel bakedModel, RenderLayer renderType, VertexConsumerProvider bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
        ...
        if (animatable.hasSnowLayer()) {
            ...
            String snowTexture = animatable.isBaby() ? "baby_capybara_snowy.png" : "capybara_snowy.png";
