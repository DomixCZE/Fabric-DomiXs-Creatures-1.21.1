...
public class WispModel extends GeoModel<WispEntity> {
    ...
    public Identifier getModelResource(WispEntity animatable) {
        return Identifier.of(DomiXsCreatures.MOD_ID, "geo/wisp.geo.json");
    }

    @Override
    public Identifier getTextureResource(WispEntity animatable) {
        return animatable.isWearingSkull()
                ? Identifier.of(DomiXsCreatures.MOD_ID, "textures/entity/wisp.png")
                : Identifier.of(DomiXsCreatures.MOD_ID, "textures/entity/wisp_without_skull.png");
    }

    @Override
    public Identifier getAnimationResource(WispEntity animatable) {
        return Identifier.of(DomiXsCreatures.MOD_ID, "animations/wisp.animation.json");
    }
}